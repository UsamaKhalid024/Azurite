/*JQUERYUIWIDGET 1.12.1 LIB STARTS*/
...
(function(factory) {
    ...
    function Datepicker() {
        ...
        this._mainDivId = "ff-ui-datepicker-div"; // The ID of the main datepicker division
        this._inlineClass = "ff-ui-datepicker-inline"; // The name of the inline marker class
        this._appendClass = "ff-ui-datepicker-append"; // The name of the append marker class
        this._triggerClass = "ff-ui-datepicker-trigger"; // The name of the trigger marker class
        this._dialogClass = "ff-ui-datepicker-dialog"; // The name of the dialog marker class
        this._disableClass = "ff-ui-datepicker-disabled"; // The name of the disabled covering marker class
        this._unselectableClass = "ff-ui-datepicker-unselectable"; // The name of the unselectable cell marker class
        this._currentClass = "ff-ui-datepicker-current-day"; // The name of the current day marker class
        this._dayOverClass = "ff-ui-datepicker-days-cell-over"; // The name of the day hover marker class
    ...
    $.extend(Datepicker.prototype, {
        ...
        _newInst: function(target, inline) {
            ...
            return {
                ...
                dpDiv: (!inline ? this.dpDiv : // presentation div
                    datepicker_bindHover($("<div class='" + this._inlineClass + " ff-ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")))
            };
        },
        ...
        _enableDatepicker: function(target) {
            ...
            if (nodeName === "input") {
                ...
                inline.find("select.ff-ui-datepicker-month, select.ff-ui-datepicker-year").
                prop("disabled", false);
            }
        ...
        _updateDatepicker: function(inst) {
            ...
            inst.dpDiv[(numMonths[0] !== 1 || numMonths[1] !== 1 ? "add" : "remove") +
                "Class"]("ff-ui-datepicker-multi");
            inst.dpDiv[(this._get(inst, "isRTL") ? "add" : "remove") +
                "Class"]("ff-ui-datepicker-rtl");
        ...
        _generateHTML: function(inst) {
            ...
            prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
                "<a class='ff-ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click'" +
                " title='" + prevText + "'><span class='ui-icon ui-icon-circle-triangle-" + (isRTL ? "e" : "w") + "'>" + prevText + "</span></a>" :
                (hideIfNoPrevNext ? "" : "<a class='ff-ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + prevText + "'><span class='ui-icon ui-icon-circle-triangle-" + (isRTL ? "e" : "w") + "'>" + prevText + "</span></a>"));
            ...
            next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
                "<a class='ff-ui-datepicker-next ui-corner-all' data-handler='next' data-event='click'" +
                " title='" + nextText + "'><span class='ui-icon ui-icon-circle-triangle-" + (isRTL ? "w" : "e") + "'>" + nextText + "</span></a>" :
                (hideIfNoPrevNext ? "" : "<a class='ff-ui-datepicker-next ui-corner-all ui-state-disabled' title='" + nextText + "'><span class='ui-icon ui-icon-circle-triangle-" + (isRTL ? "w" : "e") + "'>" + nextText + "</span></a>"));
            ...
            controls = (!inst.inline ? "<button type='button' class='ff-ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" +
                this._get(inst, "closeText") + "</button>" : "");

            buttonPanel = (showButtonPanel) ? "<div class='ff-ui-datepicker-buttonpane ui-widget-content'>" + (isRTL ? controls : "") +
                (this._isInRange(inst, gotoDate) ? "<button type='button' class='ff-ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'" +
            ...
            for (row = 0; row < numMonths[0]; row++) {
                ...
                for (col = 0; col < numMonths[1]; col++) {
                    ...
                    calender += "<div class='ff-ui-datepicker-header ui-widget-header ui-helper-clearfix" + cornerClass + "'>" +
                        (/all|left/.test(cornerClass) && row === 0 ? (isRTL ? next : prev) : "") +
                        (/all|right/.test(cornerClass) && row === 0 ? (isRTL ? prev : next) : "") +
                        this._generateMonthYearHeader(inst, drawMonth, drawYear, minDate, maxDate,
                            row > 0 || col > 0, monthNames, monthNamesShort) + // draw month headers
                        "</div><table class='ff-ui-datepicker-calendar'><thead>" +
                        "<tr>";
                    thead = (showWeek ? "<th class='ff-ui-datepicker-week-col'>" + this._get(inst, "weekHeader") + "</th>" : "");
                    for (dow = 0; dow < 7; dow++) { // days of the week
                        day = (dow + firstDay) % 7;
                        thead += "<th scope='col'" + ((dow + firstDay + 6) % 7 >= 5 ? " class='ff-ui-datepicker-week-end'" : "") + ">" +
                    ...
                    for (dRow = 0; dRow < numRows; dRow++) { // create date picker rows
                        calender += "<tr>";
                        tbody = (!showWeek ? "" : "<td class='ff-ui-datepicker-week-col'>" +
                        ...
                        for (dow = 0; dow < 7; dow++) { // create date picker days
                            ...
                            tbody += "<td class='" +
                                ((dow + firstDay + 6) % 7 >= 5 ? " ff-ui-datepicker-week-end" : "") + // highlight weekends
                                (otherMonth ? " ff-ui-datepicker-other-month" : "") + // highlight days from other months
                                ...
                                (otherMonth && !showOtherMonths ? "" : " " + daySettings[1] + // highlight custom dates
                                    ...
                                    (printDate.getTime() === today.getTime() ? " ff-ui-datepicker-today" : "")) + "'" + // highlight today (if different)
                    ...
                    calender += "</tbody></table>" + (isMultiMonth ? "</div>" +
                        ((numMonths[0] > 0 && col === numMonths[1] - 1) ? "<div class='ff-ui-datepicker-row-break'></div>" : "") : "");
                    group += calender;
                }
                html += group;
            }
    ...
    $.widget("ui.dialog", {
        ...
        _createTitlebar: function() {
            ...
            this._addClass(this.uiDialogTitlebar,
                "ff-ui-dialog-titlebar", "ui-widget-header ui-helper-clearfix");
        ...
        _createButtonPane: function() {
            ...
            this._addClass(this.uiDialogButtonPane, "ff-ui-dialog-buttonpane",
        ...
        _size: function() {
            ...
            // If the user has resized the dialog, the .ff-ui-dialog and .ff-ui-dialog-content
        ...
        _createOverlay: function() {
            ...
            this.document.data("ff-ui-dialog-overlays",
                (this.document.data("ff-ui-dialog-overlays") || 0) + 1);
        },
...
/*JQUERYUIWIDGET 1.12.1 LIB ENDS*/